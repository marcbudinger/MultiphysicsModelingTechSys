package Chap3_TorqueSensor "Torque sensor modeling (power steering)"
  model InductiveSensor1
    Modelica.Electrical.Analog.Sensors.VoltageSensor Vout annotation (
      Placement(transformation(extent={{18,-4},{-2,16}})));
    Modelica.Electrical.Analog.Basic.Ground ground1 annotation (
      Placement(transformation(extent={{18,-50},{38,-30}})));
    Modelica.Electrical.Analog.Basic.Ground ground2 annotation (
      Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 270, origin={-58,46})));
    Modelica.Electrical.Analog.Sources.SineVoltage sineVoltage(V = 5, freqHz = 5e3) annotation (
      Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 180, origin={-26,46})));
    InductiveSensorRef inductiveSensor1 annotation (
      Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin={-26,14})));
    Modelica.Electrical.Analog.Basic.Resistor R1(R = 10e3) annotation (
      Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin={28,22})));
    Modelica.Electrical.Analog.Basic.Resistor R2(R = 10e3) annotation (
      Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin={28,-14})));
    InductiveSensorVar inductiveSensorVar annotation (
      Placement(transformation(extent={{-36,-22},{-16,-2}})));
    Modelica.Mechanics.Rotational.Components.Spring spring(c = 100) annotation (
      Placement(visible = true, transformation(origin={-98,-8},     extent = {{-10, -10}, {10, 10}}, rotation = 270)));
    Modelica.Mechanics.Rotational.Components.Fixed fixed annotation (
      Placement(transformation(extent={{-108,-42},{-88,-22}})));
    Modelica.Mechanics.Rotational.Sources.Position position annotation (
      Placement(transformation(extent={{-130,14},{-110,34}})));
    Modelica.Blocks.Sources.Step step(height = 0.01, startTime = 0.05) annotation (
      Placement(transformation(extent={{-170,14},{-150,34}})));
  equation
    connect(position.flange, spring.flange_a) annotation (
      Line(points={{-110,24},{-98,24},{-98,2}}));
    connect(fixed.flange, spring.flange_b) annotation (
      Line(points={{-98,-32},{-98,-18}}));
    connect(spring.flange_b, inductiveSensorVar.flange_b) annotation (
      Line(points={{-98,-18},{-67,-18},{-67,-20},{-36,-20}}));
    connect(spring.flange_a, inductiveSensorVar.flange_a) annotation (
      Line(points={{-98,2},{-64,2},{-64,-4},{-36,-4}}));
    connect(ground2.p, sineVoltage.n) annotation (
      Line(points={{-48,46},{-36,46}},      color = {0, 0, 255}, smooth = Smooth.None));
    connect(R1.n, sineVoltage.p) annotation (
      Line(points={{28,32},{28,46},{-16,46}},        color = {0, 0, 255}, smooth = Smooth.None));
    connect(R2.p, ground1.p) annotation (
      Line(points={{28,-24},{28,-30}},    color = {0, 0, 255}, smooth = Smooth.None));
    connect(R2.n, R1.p) annotation (
      Line(points={{28,-4},{28,12}},      color = {0, 0, 255}, smooth = Smooth.None));
    connect(Vout.p, R2.n) annotation (
      Line(points={{18,6},{28,6},{28,-4}},          color = {0, 0, 255}, smooth = Smooth.None));
    connect(inductiveSensor1.p1, sineVoltage.p) annotation (
      Line(points={{-17,19},{-17,36.5},{-16,36.5},{-16,46}},          color = {0, 0, 255}, smooth = Smooth.None));
    connect(inductiveSensor1.n1, Vout.n) annotation (
      Line(points={{-17,9},{-17,6},{-2,6}},           color = {0, 0, 255}, smooth = Smooth.None));
    connect(inductiveSensorVar.p1, inductiveSensor1.n1) annotation (
      Line(points={{-15,-7},{-15,9},{-17,9}},          color = {0, 0, 255}, smooth = Smooth.None));
    connect(inductiveSensorVar.n1, ground1.p) annotation (
      Line(points={{-15,-17},{-15,-30},{28,-30}},     color = {0, 0, 255}, smooth = Smooth.None));
    connect(position.phi_ref, step.y) annotation (
      Line(points={{-132,24},{-149,24}},      color = {0, 0, 127}, smooth = Smooth.None));
    annotation (
      ...
      Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-200, -100}, {100, 100}}), graphics={
          Text(
            ...
            textString="Torsion bar"),
          Text(
            extent={{-62,30},{-36,-2}},
            lineColor={28,108,200},
            textString="Bobinage/Coil A"),
          Text(
            extent={{-62,4},{-36,-28}},
            lineColor={28,108,200},
            textString="Bobinage/Coil B")}),
  ...
  equation
    ...
    annotation (
      ...
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Rectangle(extent = {{-20, 80}, {0, -80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                            FillPattern.Solid), Rectangle(extent = {{60, 60}, {80, -60}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid), Rectangle(extent = {{20, 60}, {60, -60}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                                        FillPattern.CrossDiag), Rectangle(extent = {{20, 80}, {80, 60}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid), Rectangle(extent = {{20, -60}, {80, -80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid), Line(points = {{60, 50}, {100, 50}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{60, -50}, {100, -50}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{-60, 100}, {-60, -100}}, color = {0, 0, 255}, smooth = Smooth.None, pattern = LinePattern.DashDot), Line(points = {{-20, 80}, {-60, 80}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{-20, -80}, {-60, -80}}, color = {0, 0, 255}, smooth = Smooth.None)}));
  ...
  equation
    ...
    annotation (
      Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics),
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Rectangle(extent = {{-20, 80}, {0, 2}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                          FillPattern.Solid), Rectangle(extent = {{60, 60}, {80, -60}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid), Rectangle(extent = {{20, 60}, {60, -60}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                                        FillPattern.CrossDiag), Rectangle(extent = {{20, 80}, {80, 60}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid), Rectangle(extent = {{20, -60}, {80, -80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid), Line(points = {{60, 50}, {100, 50}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{60, -50}, {100, -50}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{-60, 100}, {-60, -100}}, color = {0, 0, 255}, smooth = Smooth.None, pattern = LinePattern.DashDot), Line(points = {{-20, 80}, {-90, 80}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{-20, -80}, {-90, -80}}, color = {0, 0, 255}, smooth = Smooth.None), Rectangle(extent = {{-20, -2}, {0, -80}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid), Rectangle(extent = {{-20, 24}, {-12, 2}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 255},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid), Rectangle(extent = {{-8, -2}, {0, -24}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 255},
...
Set the inner radius r_i=0 for modelling of a solid cylindric flux tube.
      ...
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Rectangle(extent = {{-70, 30}, {70, -30}}, lineColor = {255, 128, 0}, fillColor = {255, 170, 85},
              fillPattern =                                                                                                                                                                                                FillPattern.Solid), Rectangle(extent = {{-40, 30}, {-6, 6}}, fillColor = {255, 255, 255},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, pattern = LinePattern.None), Rectangle(extent = {{4, -6}, {38, -30}}, fillColor = {255, 255, 255},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, pattern = LinePattern.None), Rectangle(extent = {{-6, 30}, {4, -30}}, fillColor = {255, 255, 255},
              fillPattern =                                                                                                                                                                                                        FillPattern.Solid, pattern = LinePattern.None)}),
      Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics));
  end HollowCylinderAxialFluxVariable;
  annotation (
    uses(Modelica(version = "3.2.1")));
end Chap3_TorqueSensor;
