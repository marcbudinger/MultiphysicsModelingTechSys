package PerturbationsCEM
  ...
  equation
    ...
    annotation(
      Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics),
      Icon(graphics = {Line(points = {{-60, 80}, {-60, -80}, {60, 0}, {-60, 80}}, color = {0, 0, 255}, smooth = Smooth.None), Text(extent = {{-58, 42}, {24, -34}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid, textString = "A2"), Line(points = {{60, 0}, {98, 0}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{-90, 80}, {-80, 80}, {-80, 60}, {-60, 60}}, color = {0, 0, 255}, smooth = Smooth.None), Line(points = {{-90, -80}, {-80, -80}, {-80, -60}, {-60, -60}}, color = {0, 0, 255}, smooth = Smooth.None), Text(extent = {{-116, 76}, {-84, 48}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid, textString = "+"), Text(extent = {{-116, -48}, {-84, -76}}, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid, textString = "-")}));
  end DifferentialAmplifier;
  annotation(
    uses(Modelica(version = "3.2.1")));
end PerturbationsCEM;
